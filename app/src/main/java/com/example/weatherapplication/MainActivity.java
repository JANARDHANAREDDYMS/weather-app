...
//        }
        ...
        Location manualLocation = new Location(LocationManager.NETWORK_PROVIDER);
        manualLocation.setLatitude(12.971599);
        manualLocation.setLongitude(77.594566);

        Citynameee = getcityname(manualLocation.getLongitude(), manualLocation.getLatitude());
        getweatherinfo(Citynameee);
